export function getContactPopupUserHtml() {
  return `
    <!DOCTYPE html>
    <html lang="de">
      <head>
                ...
                <tr>
                  <td align="center" style="padding: 40px 30px 0;">
                    <h1 class="fallback-font" style="margin:0 0 20px; font-size:24px; font-weight: 600; line-height:140%; color:#111111;">
                      Liebe Patientinnen und Patienten sowie Interessierte
                    </h1> 
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 5px 30px; margin: 0;">
                    <p class="fallback-font" style="margin: 0;">Vielen Dank! Ihre Nachricht ist bei uns eingegangen und wird zeitnah bearbeitet</p>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 5px 30px; margin: 0;">
                    <p class="fallback-font" style="margin: 0;">Falls Rückfragen bestehen, melden wir uns bei Ihnen</p>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 5px 30px 40px; margin: 0;">
                    <p class="fallback-font" style="margin: 0;">Ihr Praxisteam</p>
                  </td>
                </tr>
              </table>
            </td>
